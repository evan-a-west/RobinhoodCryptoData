...
EC2 setup: 
1) Install python3.8 by running the command: sudo amazon-linux-extras install python3.8
...
5) using 'python3.8 -m pip install ...', install the following packages: robin-stocks, numpy, pytz, dropbox
6) Install git:
	a) sudo yum update -y
